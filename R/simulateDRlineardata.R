simulateDRlineardata.fun=function(beta.pooled=0.01,tau=0.001,ns=20,doserange=c(1, 80),samplesize=200){ #
  ...
  # maxRR<-exp(maxlogRR)
  p0<-0.1#*/maxRR#set p0 to be hlf the maximum allowed, just to be on the safe side!
